import { NavItem, Stat, Facility, LocationItem, RoomSize, Service, BlogPost, Commune, Property } from './types';
...
// ⚠️ PORTEFEUILLE DE DÉMONSTRATION — à remplacer par les biens réellement
// mandatés avant mise en ligne. La page /nos-biens affiche automatiquement
// un état vide (« aucun bien disponible ») si ce tableau est vidé.
export const PROPERTIES: Property[] = [
  {
    ...
    bathrooms: 3,
    description:
      'Villa d’architecte sur un terrain paysager de 1 200 m², à 5 minutes du lac et 20 minutes de Genève. Vastes volumes traversants, piscine chauffée et vue dégagée sur le Jura.',
    image: 'https://madebydesignesia.com/themes/homely/images/gallery/1.webp',
    highlights: ['Piscine chauffée', 'Terrain 1 200 m²', 'Vue Jura'],
  },
  {
    id: 2,
    ...
    bathrooms: 2,
    description:
      'Dernier étage dans une résidence récente à deux pas de l’aéroport de Genève et du bus F. Terrasse plein sud de 22 m², double garage en sous-sol.',
    image: 'https://madebydesignesia.com/themes/homely/images/gallery/2.webp',
    highlights: ['Dernier étage', 'Terrasse 22 m²', 'Double garage'],
  },
  {
    id: 3,
    title: 'Maison familiale au calme',
    ...
    bathrooms: 2,
    description:
      'Maison individuelle de 2016 en impasse, idéale pour une famille du CERN. Jardin clos exposé sud-ouest, cuisine équipée et bureau indépendant.',
    image: 'https://madebydesignesia.com/themes/homely/images/gallery/3.webp',
    highlights: ['Proche CERN', 'Jardin clos', 'Construction 2016'],
  },
  {
    id: 4,
    title: 'Duplex de standing centre-ville',
    commune: 'Gex',
    type: 'Appartement',
    status: 'À vendre',
    price: 578000,
    ...
    bathrooms: 2,
    description:
      'Duplex lumineux au cœur de Gex, commerces et écoles accessibles à pied. Prestations soignées, poutres apparentes et cave voûtée.',
    image: 'https://madebydesignesia.com/themes/homely/images/gallery/4.webp',
    highlights: ['Centre-ville', 'Poutres apparentes', 'Cave voûtée'],
  },
  {
    id: 5,
    title: 'Propriété d’exception vue lac',
    commune: 'Crozet',
    type: 'Villa',
    status: 'À vendre',
    price: 2450000,
    ...
    bathrooms: 4,
    description:
      'Propriété en position dominante avec vue panoramique sur le lac Léman et le Mont-Blanc. Parc arboré de 3 000 m², dépendance et garage triple.',
    image: 'https://madebydesignesia.com/themes/homely/images/gallery/5.webp',
    highlights: ['Vue lac & Mont-Blanc', 'Parc 3 000 m²', 'Dépendance'],
  },
  {
    id: 6,
    ...
    bathrooms: 0,
    description:
      'Terrain plat et viabilisé, libre de constructeur, dans un secteur résidentiel recherché à 25 minutes de Genève. Certificat d’urbanisme obtenu.',
    image: 'https://madebydesignesia.com/themes/homely/images/demo/homepage-2.webp',
    highlights: ['Libre de constructeur', 'Viabilisé', 'CU obtenu'],
  },
];
