 ...
 * ouvre la conversation de l'agence avec un message prérempli.
 * Vert officiel WhatsApp, halo pulsé (désactivé si prefers-reduced-motion),
 * libellé contextuel au survol desktop. z-30 : sous la navbar/son menu.
 */
